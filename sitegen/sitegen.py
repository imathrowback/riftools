...
TELARADB_JAR = ROOT_DIR / "telaradbdiff" / "build" / "jar" / "telaradbdiff.jar"
MANIFEST_DIFF_JAR = ROOT_DIR / "ManifestDiff" / "build" / "jar" / "ManifestDiff.jar"
TOTEXT_JAR = ROOT_DIR / "totext" / "build" / "jar" / "totext.jar"
