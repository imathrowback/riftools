...
public class RC4
{
	...
	public RC4(final String key) throws InvalidKeyException
	{
		this();
		setKey(key);
	}
	 ...
	 */
	public byte[] encryptMessage(final String message, final Charset charset, final String key)
	 ...
	 */
	public byte[] encryptMessage(final String message, final String key)
			throws InvalidKeyException
	{
	 ...
	 * @throws InvalidKeyException if key length is smaller than 5 or bigger than 255
	 */
	public String decryptMessage(final byte[] message, final Charset charset, final String key)
			throws InvalidKeyException
	{
		reset();
		setKey(key);
	 ...
	 * @see StandardCharsets
	 */
	public String decryptMessage(final byte[] message, final String key)
			throws InvalidKeyException
	{
	 ...
	 * @throws InvalidKeyException if key length is smaller than 5 or bigger than 255
	 */
	public void setKey(final String key) throws InvalidKeyException
	{
