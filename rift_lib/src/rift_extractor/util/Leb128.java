...
public final class Leb128
{
	 ...
	 */
	public static int readSignedLeb128(final InputStream in) throws IOException
	{
		int result = 0;
		int cur;
		int count = 0;
	 ...
	 */
	public static int readUnsignedLeb128(final InputStream in) throws IOException
	{
		int result = 0;
		int cur;
		int count = 0;
	 ...
	 * Reads an unsigned integer from {@code in}.
	 */
	public static Optional<Integer> readUnsignedLeb128_X(final LittleEndianDataInputStream diss)
			throws IOException
	{
		int result = 0;
		int i = 0;
		...
		while (i < 35)
		{
			...
			//System.out.println("readUnsignedLeb128_XX:[" + i + "]" + result + " cbyte:" + currentByte);
			if (currentByte >= 0)
			{
	 ...
	 */
	public static void writeUnsignedLeb128(final OutputStream out, int value) throws IOException
	{
		int remaining = value >>> 7;
	 ...
	 * {@code offset}. Returns the number of bytes written.
	 */
	public static void writeSignedLeb128(final OutputStream out, int value) throws IOException
	{
		int remaining = value >> 7;
		boolean hasMore = true;
		int end = ((value & Integer.MIN_VALUE) == 0) ? 0 : -1;
